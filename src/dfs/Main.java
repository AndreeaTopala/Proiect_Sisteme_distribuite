...
public class Main {
 ...
 static String str1;
    ...
    public static void show_files() {
        ...
        File directoryPath = new File("C:\\Users\\Andreeaa Topala\\Desktop\\Proiect Sisteme distribuite\\DFS-java-project\\Replica_0"); 
        ...
        for (int i = 0; i < contents.length; i++) {
            directoryPathAux=new File("C:\\Users\\Andreeaa Topala\\Desktop\\Proiect Sisteme distribuite\\DFS-java-project\\Replica_0"+contents[i]);
    ...
    public static void delete_file() throws IOException, NotBoundException, MessageNotFoundException {
        ...
        for (int x = 0; x < 3; x++) { 
            String fileName = "C:\\Users\\Andreeaa Topala\\Desktop\\Proiect Sisteme distribuite\\DFS-java-project\\Replica_" + x + "\\" + file_delete;
            try {
